...
\pdfinfo{
   /Author (Diego Pérez)
   %/Title (Leveraging Modern Multi-core Processor Features to Efficiently Deal with Silent Errors)
   /Title (Improving redundant multithreading performance for soft-error detection in HPC applications)
...
\lstdefinelanguage{pseudocode}{
	language     = c,
	morekeywords = {check, produce, consume}
}                                    
